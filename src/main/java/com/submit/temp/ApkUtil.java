...
public class ApkUtil {
    ...
    //  apk的绝对地址
    private static String apk = "E:\\app\\dianping.apk";
//    private static String apk = "G:\\fangdajing.png";
    //  拷贝图标的存放位置
    private static String fileName = "G:\\" + name + ".png";
